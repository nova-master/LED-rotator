...
HD_PWD='C:/Users/Anti-cheat-WIN10/Desktop/shiftLAR/shiftLAR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOPLED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOPLED.tcl -notrace
