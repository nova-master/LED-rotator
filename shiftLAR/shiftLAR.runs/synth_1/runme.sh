...
HD_PWD='C:/Users/Anti-cheat-WIN10/Desktop/shiftLAR/shiftLAR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOPLED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOPLED.tcl
